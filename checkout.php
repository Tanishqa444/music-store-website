...
<section class="display-order">
    ...
    ?>    
    <p> <?php echo $fetch_cart['name'] ?> <span>(<?php echo 'Ruppee-'.$fetch_cart['price'].'/-'.' x '.$fetch_cart['quantity']  ?>)</span> </p>
    <?php
        }
        }else{
    ...
    ?>
    <div class="grand-total">grand total : <span>Ruppee-<?php echo $grand_total; ?>/-</span></div>
</section>
